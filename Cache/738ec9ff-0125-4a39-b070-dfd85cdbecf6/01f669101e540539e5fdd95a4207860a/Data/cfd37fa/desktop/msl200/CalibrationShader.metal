...
//float CurrSize 4148
//float4 LoadingColor 4160
//float Amount 4176
//float4 StartColor 4192
//float StartSize 4208
//float4 IconTexSize 4224
//float4 IconTexDims 4240
//float4 IconTexView 4256
//float3x3 IconTexTransform 4272
//float4 IconTexUvMinMax 4320
//float4 IconTexBorderColor 4336
//float Port_Rotation_N014 4352
//float2 Port_Center_N014 4360
//float2 Port_Offset_N013 4368
//float Port_Import_N177 4376
//float Port_Import_N179 4380
//float Port_Input0_N008 4384
//float Port_Input0_N018 4388
//float Port_RangeMinA_N010 4392
//float Port_RangeMaxA_N010 4396
//float Port_RangeMinB_N010 4400
//float Port_RangeMaxB_N010 4404
//float Port_RangeMaxA_N029 4408
//float Port_RangeMinB_N029 4412
//float Port_RangeMaxB_N029 4416
//float2 Port_Center_N026 4424
//float Port_RangeMinA_N032 4432
//float Port_RangeMinB_N032 4436
//float Port_RangeMaxB_N032 4440
//float depthRef 4444
//}
...
//spec_const bool IconTexHasSwappedViews 31
//spec_const bool SC_USE_CLAMP_TO_BORDER_IconTex 32
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 33
//spec_const bool SC_USE_UV_MIN_MAX_IconTex 34
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 35
//spec_const bool SC_USE_UV_TRANSFORM_IconTex 36
...
//spec_const int IconTexLayout 70
//spec_const int SC_SOFTWARE_WRAP_MODE_U_IconTex 71
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72
//spec_const int SC_SOFTWARE_WRAP_MODE_V_IconTex 73
...
constant int IconTexLayout [[function_constant(70)]];
constant int IconTexLayout_tmp = is_function_constant_defined(IconTexLayout) ? IconTexLayout : 0;
constant int SC_SOFTWARE_WRAP_MODE_U_IconTex [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_IconTex [[function_constant(73)]];
...
float2 l9_9=l9_7;
float l9_10=(*sc_set0.UserUniforms).Port_Rotation_N014;
float2 l9_11=(*sc_set0.UserUniforms).Port_Center_N014;
...
l9_15=l9_8+(*sc_set0.UserUniforms).Port_Offset_N013;
float l9_16=0.0;
float l9_17=0.0;
float2 l9_18=l9_15;
float l9_19=l9_18.x;
...
l9_28=l9_26;
float l9_29=0.0;
float l9_30=(*sc_set0.UserUniforms).CurrSize;
l9_29=l9_30;
float l9_31=0.0;
l9_31=(*sc_set0.UserUniforms).Port_Input0_N008-l9_29;
float l9_32=0.0;
...
float4 l9_34=(*sc_set0.UserUniforms).LoadingColor;
l9_33=l9_34;
param_1=l9_33.xyz;
param_3=param_1;
}
...
float2 l9_42=l9_40;
float l9_43=(*sc_set0.UserUniforms).Port_Rotation_N014;
float2 l9_44=(*sc_set0.UserUniforms).Port_Center_N014;
...
l9_48=l9_41+(*sc_set0.UserUniforms).Port_Offset_N013;
float l9_49=0.0;
float l9_50=0.0;
float2 l9_51=l9_48;
float l9_52=l9_51.x;
...
l9_61=l9_59;
float l9_62=0.0;
float l9_63=(*sc_set0.UserUniforms).CurrSize;
l9_62=l9_63;
float l9_64=0.0;
l9_64=(*sc_set0.UserUniforms).Port_Input0_N008-l9_62;
float l9_65=0.0;
l9_65=float(l9_61<l9_64);
float l9_66=0.0;
l9_66=(*sc_set0.UserUniforms).Port_Input0_N018+l9_62;
float l9_67=0.0;
...
l9_74=l9_73;
float l9_75=0.0;
float l9_76=(*sc_set0.UserUniforms).Amount;
l9_75=l9_76;
float l9_77=0.0;
l9_77=(((l9_75-(*sc_set0.UserUniforms).Port_RangeMinA_N010)/((*sc_set0.UserUniforms).Port_RangeMaxA_N010-(*sc_set0.UserUniforms).Port_RangeMinA_N010))*((*sc_set0.UserUniforms).Port_RangeMaxB_N010-(*sc_set0.UserUniforms).Port_RangeMinB_N010))+(*sc_set0.UserUniforms).Port_RangeMinB_N010;
float l9_78=0.0;
...
float4 l9_85=(*sc_set0.UserUniforms).LoadingColor;
l9_84=l9_85;
l9_37=l9_84.xyz;
l9_83=l9_37;
}
...
float4 l9_87=(*sc_set0.UserUniforms).StartColor;
l9_86=l9_87;
l9_38=l9_86.xyz;
l9_83=l9_38;
}
...
float param_6=(*sc_set0.UserUniforms).Port_Rotation_N014;
float2 param_7=(*sc_set0.UserUniforms).Port_Center_N014;
...
float Output_N6=0.0;
float param_12=(*sc_set0.UserUniforms).CurrSize;
Output_N6=param_12;
float Output_N8=0.0;
...
float l9_100=0.0;
float l9_101=(*sc_set0.UserUniforms).CurrSize;
l9_100=l9_101;
float l9_102=0.0;
float l9_103=(*sc_set0.UserUniforms).StartSize;
l9_102=l9_103;
float l9_104=0.0;
l9_104=(((l9_100-l9_102)/((*sc_set0.UserUniforms).Port_RangeMaxA_N029-l9_102))*((*sc_set0.UserUniforms).Port_RangeMaxB_N029-(*sc_set0.UserUniforms).Port_RangeMinB_N029))+(*sc_set0.UserUniforms).Port_RangeMinB_N029;
float2 l9_105=float2(0.0);
l9_105.x=l9_104;
l9_105.y=l9_104;
float2 l9_106=float2(0.0);
l9_106=((l9_99-(*sc_set0.UserUniforms).Port_Center_N026)*l9_105)+(*sc_set0.UserUniforms).Port_Center_N026;
...
float3x3 l9_118=(*sc_set0.UserUniforms).IconTexTransform;
...
float4 l9_121=(*sc_set0.UserUniforms).IconTexUvMinMax;
bool l9_122=(int(SC_USE_CLAMP_TO_BORDER_IconTex_tmp)!=0);
float4 l9_123=(*sc_set0.UserUniforms).IconTexBorderColor;
float l9_124=0.0;
...
float l9_194=l9_186;
float4 l9_195=sc_set0.IconTex.sample(sc_set0.IconTexSmpSC,l9_193,bias(l9_194));
...
float l9_201=0.0;
float l9_202=(*sc_set0.UserUniforms).CurrSize;
l9_201=l9_202;
float l9_203=0.0;
float l9_204=(*sc_set0.UserUniforms).StartSize;
l9_203=l9_204;
float l9_205=0.0;
l9_205=(((l9_201-l9_203)/((*sc_set0.UserUniforms).Port_RangeMaxA_N029-l9_203))*((*sc_set0.UserUniforms).Port_RangeMaxB_N029-(*sc_set0.UserUniforms).Port_RangeMinB_N029))+(*sc_set0.UserUniforms).Port_RangeMinB_N029;
float2 l9_206=float2(0.0);
l9_206.x=l9_205;
l9_206.y=l9_205;
float2 l9_207=float2(0.0);
l9_207=((l9_200-(*sc_set0.UserUniforms).Port_Center_N026)*l9_206)+(*sc_set0.UserUniforms).Port_Center_N026;
...
float3x3 l9_219=(*sc_set0.UserUniforms).IconTexTransform;
...
float4 l9_222=(*sc_set0.UserUniforms).IconTexUvMinMax;
bool l9_223=(int(SC_USE_CLAMP_TO_BORDER_IconTex_tmp)!=0);
float4 l9_224=(*sc_set0.UserUniforms).IconTexBorderColor;
float l9_225=0.0;
...
float l9_295=l9_287;
float4 l9_296=sc_set0.IconTex.sample(sc_set0.IconTexSmpSC,l9_294,bias(l9_295));
...
l9_300=l9_208.w;
float l9_301=0.0;
l9_301=(((l9_201-(*sc_set0.UserUniforms).Port_RangeMinA_N032)/(l9_203-(*sc_set0.UserUniforms).Port_RangeMinA_N032))*((*sc_set0.UserUniforms).Port_RangeMaxB_N032-(*sc_set0.UserUniforms).Port_RangeMinB_N032))+(*sc_set0.UserUniforms).Port_RangeMinB_N032;
...
bool l9_307=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_307)
{
...
float l9_312=l9_311;
float l9_313=l9_312;
float l9_314=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_313;
float3 l9_315=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_309.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_321.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_324=l9_323.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_361=l9_353;
float4 l9_362=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_360,bias(l9_361));
...
float3 l9_372=definedBlend(l9_370,l9_371,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_380=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_380=float4(0.0);
