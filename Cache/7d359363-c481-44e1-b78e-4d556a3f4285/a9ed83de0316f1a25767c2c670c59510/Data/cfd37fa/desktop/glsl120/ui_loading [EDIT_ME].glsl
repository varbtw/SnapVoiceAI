...
l9_11.w=Port_Value2_N073;
l9_9=varColor*l9_11;
}
#else
{
vec3 l9_12;
Node80_If_else(0.0,vec3(0.0),vec3(0.0),l9_12,l9_8);
vec4 l9_13=vec4(l9_12.x,l9_12.y,l9_12.z,vec4(0.0).w);
l9_13.w=Port_Value2_N073;
l9_9=l9_13;
}
#endif
vec4 l9_14=l9_9*vec4(step(varPackedTex.y,progress_value));
vec3 param_3;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),param_3,l9_8);
vec3 l9_15=param_3;
vec3 l9_16;
#if (NODE_38_DROPLIST_ITEM==2)
{
vec4 l9_17;
Node132_If_else(0.0,vec4(0.0),Port_Default_N132,l9_17,l9_8);
l9_16=varColor.xyz+l9_17.xyz;
}
#else
{
vec4 l9_18;
Node132_If_else(0.0,vec4(0.0),Port_Default_N132,l9_18,l9_8);
l9_16=l9_18.xyz;
}
#endif
vec3 l9_19=ssSRGB_to_Linear((l9_16*emissiveColor)*vec3(emissiveIntensity));
vec3 l9_20;
#if (Tweak_N179)
{
vec3 l9_21;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),l9_21,l9_8);
vec3 l9_22=l9_21;
vec3 l9_23=reflect(l9_7,l9_22)*Port_Input1_N257;
float l9_24=l9_23.x;
float l9_25=l9_23.y;
float l9_26=l9_23.z+Port_Input1_N264;
float l9_27=((l9_24*l9_24)+(l9_25*l9_25))+(l9_26*l9_26);
float l9_28;
if (l9_27<=0.0)
{
l9_28=0.0;
...
float l9_29=l9_28*Port_Input1_N268;
vec2 l9_30=vec2(1.0)-((vec2(l9_24,l9_25)/vec2(l9_29))+vec2(Port_Input1_N270));
int l9_31;
...
#endif
float l9_32=l9_30.x;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x);
float l9_33=l9_32;
float l9_34=l9_30.y;
sc_SoftwareWrapEarly(l9_34,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y);
float l9_35=l9_34;
vec2 l9_36;
float l9_37;
...
{
l9_38=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x==3;
}
#else
{
l9_38=(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0);
}
#endif
float l9_39=l9_33;
float l9_40=1.0;
sc_ClampUV(l9_39,reflectionTexUvMinMax.x,reflectionTexUvMinMax.z,l9_38,l9_40);
float l9_41=l9_39;
float l9_42=l9_40;
bool l9_43;
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
l9_43=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y==3;
}
#else
{
l9_43=(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0);
}
#endif
float l9_44=l9_35;
float l9_45=l9_42;
sc_ClampUV(l9_44,reflectionTexUvMinMax.y,reflectionTexUvMinMax.w,l9_43,l9_45);
l9_37=l9_45;
...
#endif
vec2 l9_46=sc_TransformUV(l9_36,(int(SC_USE_UV_TRANSFORM_reflectionTex)!=0),reflectionTexTransform);
float l9_47=l9_46.x;
float l9_48=l9_37;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).x,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0)),l9_48);
float l9_49=l9_46.y;
float l9_50=l9_48;
sc_SoftwareWrapLate(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionTex,SC_SOFTWARE_WRAP_MODE_V_reflectionTex).y,(int(SC_USE_CLAMP_TO_BORDER_reflectionTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionTex)!=0)),l9_50);
float l9_51=l9_50;
vec3 l9_52=sc_SamplingCoordsViewToGlobal(vec2(l9_47,l9_49),reflectionTexLayout,l9_31);
vec4 l9_53=texture2D(reflectionTex,l9_52.xy,0.0);
vec4 l9_54;
#if (SC_USE_CLAMP_TO_BORDER_reflectionTex)
{
l9_54=mix(reflectionTexBorderColor,l9_53,vec4(l9_51));
}
#else
{
l9_54=l9_53;
...
{
vec2 l9_59;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_59,l9_8);
float l9_60;
Node67_Bool_Parameter(l9_60,l9_8);
l9_58=mix(varPackedTex.xy,l9_59,vec2(l9_60));
}
#else
{
vec2 l9_61;
...
{
vec2 l9_62;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_62,l9_8);
float l9_63;
Node11_Bool_Parameter(l9_63,l9_8);
l9_61=mix(varPackedTex.xy,l9_62,vec2(l9_63));
}
#else
{
l9_61=varPackedTex.xy;
}
#endif
l9_58=l9_61;
}
...
#endif
float l9_65=l9_56.x;
sc_SoftwareWrapEarly(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x);
float l9_66=l9_65;
float l9_67=l9_56.y;
sc_SoftwareWrapEarly(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y);
float l9_68=l9_67;
vec2 l9_69;
float l9_70;
...
{
l9_71=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x==3;
}
#else
{
l9_71=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0);
}
#endif
float l9_72=l9_66;
float l9_73=1.0;
sc_ClampUV(l9_72,reflectionModulationTexUvMinMax.x,reflectionModulationTexUvMinMax.z,l9_71,l9_73);
float l9_74=l9_72;
float l9_75=l9_73;
bool l9_76;
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_76=ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y==3;
}
#else
{
l9_76=(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0);
}
#endif
float l9_77=l9_68;
float l9_78=l9_75;
sc_ClampUV(l9_77,reflectionModulationTexUvMinMax.y,reflectionModulationTexUvMinMax.w,l9_76,l9_78);
l9_70=l9_78;
...
#endif
vec2 l9_79=sc_TransformUV(l9_69,(int(SC_USE_UV_TRANSFORM_reflectionModulationTex)!=0),reflectionModulationTexTransform);
float l9_80=l9_79.x;
float l9_81=l9_70;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).x,(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0)),l9_81);
float l9_82=l9_79.y;
float l9_83=l9_81;
sc_SoftwareWrapLate(l9_82,ivec2(SC_SOFTWARE_WRAP_MODE_U_reflectionModulationTex,SC_SOFTWARE_WRAP_MODE_V_reflectionModulationTex).y,(int(SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_reflectionModulationTex)!=0)),l9_83);
float l9_84=l9_83;
vec3 l9_85=sc_SamplingCoordsViewToGlobal(vec2(l9_80,l9_82),reflectionModulationTexLayout,l9_64);
vec4 l9_86=texture2D(reflectionModulationTex,l9_85.xy,0.0);
vec4 l9_87;
#if (SC_USE_CLAMP_TO_BORDER_reflectionModulationTex)
{
l9_87=mix(reflectionModulationTexBorderColor,l9_86,vec4(l9_84));
}
#else
{
l9_87=l9_86;
...
#else
{
l9_55=Port_Default_N041;
}
#endif
l9_20=vec3(reflectionIntensity)*ssSRGB_to_Linear(l9_54.xyz*l9_55);
}
#else
{
l9_20=Port_Default_N134;
}
#endif
vec3 l9_88;
#if (Tweak_N74)
...
{
vec2 l9_93;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_93,l9_8);
float l9_94;
Node67_Bool_Parameter(l9_94,l9_8);
l9_92=mix(varPackedTex.xy,l9_93,vec2(l9_94));
}
#else
{
vec2 l9_95;
...
{
vec2 l9_96;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_96,l9_8);
float l9_97;
Node11_Bool_Parameter(l9_97,l9_8);
l9_95=mix(varPackedTex.xy,l9_96,vec2(l9_97));
}
#else
{
l9_95=varPackedTex.xy;
}
#endif
l9_92=l9_95;
}
...
float l9_115=l9_104;
sc_SoftwareWrapLate(l9_114,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).x,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0)),l9_115);
float l9_116=l9_113.y;
float l9_117=l9_115;
sc_SoftwareWrapLate(l9_116,ivec2(SC_SOFTWARE_WRAP_MODE_U_rimColorTex,SC_SOFTWARE_WRAP_MODE_V_rimColorTex).y,(int(SC_USE_CLAMP_TO_BORDER_rimColorTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_rimColorTex)!=0)),l9_117);
float l9_118=l9_117;
vec3 l9_119=sc_SamplingCoordsViewToGlobal(vec2(l9_114,l9_116),rimColorTexLayout,l9_98);
...
#else
{
l9_89=Port_Default_N170;
}
#endif
vec3 l9_122=ssSRGB_to_Linear((rimColor*vec3(rimIntensity))*l9_89);
float l9_123;
#if (rimInvert)
{
vec3 l9_124;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),l9_124,l9_8);
l9_123=abs(dot(l9_124,-l9_7));
}
#else
{
vec3 l9_125;
Node337_If_else(0.0,vec3(0.0),vec3(0.0),l9_125,l9_8);
l9_123=1.0-abs(dot(l9_125,-l9_7));
}
#endif
float l9_126;
if (l9_123<=0.0)
...
l9_88=l9_122*vec3(l9_126);
}
#else
{
l9_88=Port_Default_N173;
}
#endif
vec3 l9_127=l9_19+l9_20;
vec3 l9_128=l9_127+l9_88;
vec3 l9_129;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
float l9_131=clamp(l9_14.w,0.0,1.0);
...
#endif
vec3 l9_132=max(l9_14.xyz,vec3(0.0));
vec4 l9_133;
#if (sc_ProjectiveShadowsCaster)
{
...
SurfaceProperties l9_139=SurfaceProperties(l9_138,l9_131,l9_135,varPos,l9_7,0.0,1.0,l9_136,l9_137,vec3(1.0),vec3(1.0),vec3(0.039999999));
...
{
LightingComponents l9_160=accumulateLight(LightingComponents(l9_148,l9_149,l9_154,l9_152,l9_151,l9_150),LightProperties(sc_DirectionalLights[l9_159].direction,sc_DirectionalLights[l9_159].color.xyz,sc_DirectionalLights[l9_159].color.w*l9_140[(l9_153<3) ? l9_153 : 3]),l9_139,l9_7);
...
l9_170=l9_178+1;
LightingComponents l9_185=accumulateLight(LightingComponents(l9_164,l9_165,l9_169,l9_168,l9_167,l9_166),LightProperties(l9_180,sc_PointLights[l9_177].color.xyz,l9_184),l9_139,l9_7);
...
#endif
l9_196=sc_EnvmapSpecularSampleViewIndexBias(l9_197,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_198;
...
#else
{
l9_198=sc_EnvmapSpecularSampleViewIndexBias(l9_195,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_196=l9_198;
}
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_269=l9_249.w;
l9_268=vec4(mix(vec3(1.0),l9_249.xyz,vec3(l9_269)),l9_269);
}
#else
{
vec4 l9_270;
...
{
float l9_271=l9_249.w;
float l9_272;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_272=clamp(l9_271,0.0,1.0);
}
#else
{
l9_272=l9_271;
...
#endif
l9_270=vec4(l9_249.xyz*l9_272,l9_272);
}
#else
{
l9_270=l9_249;
...
{
l9_275=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_275=vec4(0.0);
...
vec4 l9_277=outputMotionVectorsIfNeeded(varPos,max(l9_276,vec4(0.0)));
vec4 l9_278=clamp(l9_277,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_279=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_279-0.0039215689)),min(1.0,l9_279+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_280=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_280).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_281=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_280).xy);
float l9_282=packValue(l9_281);
int l9_289=int(l9_278.w*255.0);
float l9_290=packValue(l9_289);
sc_writeFragData0(vec4(packValue(l9_281),packValue(l9_281),packValue(l9_281),packValue(l9_281)));
sc_writeFragData1(vec4(l9_282,packValue(l9_281),packValue(l9_281),packValue(l9_281)));
sc_writeFragData2(vec4(l9_290,packValue(l9_289),packValue(l9_289),packValue(l9_289)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_293=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_293).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_298==0)
{
l9_301=texture2D(sc_OITAlpha0,l9_293);
l9_300=texture2D(sc_OITDepthLow0,l9_293);
l9_299=texture2D(sc_OITDepthHigh0,l9_293);
}
else
{
l9_301=vec4(0.0);
...
if (l9_298==1)
{
l9_304=texture2D(sc_OITAlpha1,l9_293);
l9_303=texture2D(sc_OITDepthLow1,l9_293);
l9_302=texture2D(sc_OITDepthHigh1,l9_293);
}
else
{
l9_304=l9_301;
...
if (any(notEqual(l9_302,vec4(0.0)))||any(notEqual(l9_303,vec4(0.0))))
{
int l9_305[8]=l9_294;
unpackValues(l9_302.w,l9_298,l9_305);
unpackValues(l9_302.z,l9_298,l9_305);
unpackValues(l9_302.y,l9_298,l9_305);
unpackValues(l9_302.x,l9_298,l9_305);
unpackValues(l9_303.w,l9_298,l9_305);
unpackValues(l9_303.z,l9_298,l9_305);
unpackValues(l9_303.y,l9_298,l9_305);
unpackValues(l9_303.x,l9_298,l9_305);
int l9_314[8]=l9_295;
unpackValues(l9_304.w,l9_298,l9_314);
unpackValues(l9_304.z,l9_298,l9_314);
unpackValues(l9_304.y,l9_298,l9_314);
unpackValues(l9_304.x,l9_298,l9_314);
}
l9_298++;
continue;
}
...
vec4 l9_319=texture2D(sc_OITFilteredDepthBoundsTexture,l9_293);
vec2 l9_320=l9_319.xy;
int l9_321;
#if (sc_SkinBonesCount>0)
{
l9_321=encodeDepth(((1.0-l9_319.x)*1000.0)+getDepthOrderingEpsilon(),l9_320);
}
#else
{
l9_321=0;
...
#endif
int l9_322=encodeDepth(viewSpaceDepth(),l9_320);
vec4 l9_323;
l9_323=l9_278*l9_278.w;
vec4 l9_324;
int l9_325=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_325<8)
{
int l9_326=l9_294[l9_325];
int l9_327=l9_322-l9_321;
bool l9_328=l9_326<l9_327;
bool l9_329;
if (l9_328)
{
l9_329=l9_294[l9_325]>0;
}
else
{
l9_329=l9_328;
...
if (l9_329)
{
vec3 l9_330=l9_323.xyz*(1.0-(float(l9_295[l9_325])/255.0));
l9_324=vec4(l9_330.x,l9_330.y,l9_330.z,l9_323.w);
}
else
{
l9_324=l9_323;
